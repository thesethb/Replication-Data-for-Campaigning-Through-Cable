...
guestList = open('foxGuestList.csv','w')
folderList = ['2020','2019','2018','2017','2016','2015','2014','2013','2012','2011','2010','2009']
guestList.write('Date,Guest,Primetime,Tucker\n')
for f in folderList:
    fileList = []
    directory = r'./Fox/' + f
    ...
    for d in range(len(fileList)):
        ...
        pdfFileObj = open('./Fox/' + f + '/' + fileList[d], 'rb')
        ...
        for i in range(pages):
                ...
                if i == 0:
                    ...
                    guests = guests.replace(',','')
                    guestList.write(date + ',' + guests[1:len(guests)] + ',' + str(primetime) + ',' + str(tucker)+ '\n')
                    break
